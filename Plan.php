...
<head>
  <meta charset="utf-8">
  <title>Plan preparation, monitoring and evaluation directorate</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Plan Preparation, Monitoring and Evaluation Directorate</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			...
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>Plan Preparation, Monitoring and Evaluation Directorate</strong></h4>
					<p>
					...
					<h6>Highlights of this year’s performance</h6>
					 
					<ul>
						<li>Well organized classroom management system
						</li>
						<li class="margintop10"> Started studies by cooperative learning in dormitories with download audio - visual materials and digital library
						</li>
						<li class="margintop10">Equipped  core reference books in 3:1 ratio (3 books to 1 student) - GTP II estimated target is 1 book to 5 students
						</li>
						<li class="margintop10">Performance budgeting was successfully rolled out to almost all work units
						</li>
						<li>Established especial office for international alignment & lobbying</li>
						<li>Implemented Academic Promotion and Reputability Guideline</li>
						<li>Established Regional Research Forum</li>
						<li>Started one card system, online grade submission, security camera in library & students cafeteria</li>
						<li>Started exam banking </li>
						<li>Technology transfer in eight fields</li>
						<li>Implemented think out of the box philosophy and made all work units to lead, organize and works in new ways</li>
					</ul>
