      ...
      <div class="container ">
	   <div class="row nomargin">
          <div class="span12">
            <div class="headnav">
              <ul>
                  <li><a href="https://fb.me/irjju" data-placement="bottom" title="Facebook"><i class="icon-facebook icon-circled icon-48 active"></i></a></li>
            ...
            <div id="mySignin" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                  <form action="app/process_1.php" class="form-horizontal" method="POST">
                  <div class="control-group">
