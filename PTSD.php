...
<head>
  <meta charset="utf-8">
  <title>Property and transportation service directorate</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Property and transportation service directorate</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			...
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>Property and transportation service directorate (PTSD)</strong></h4>
					<p>
					...
					<p><ins>
					Finally, although the Property and Transportation Service Directorate is a newly organized directorate, some of its achievements include: </ins>
					</p>
					 
					<ul>
						<li>The implementation of Asset Management Soft Ware which is a Computer based asset management Soft ware that enables encoding of the University’s asset data and tracking the University’s Fixed Assets
						</li>
						<li class="margintop10"> The implementation of Mini-Garage or work shop by the Transport section which enabled the minor maintenance of the University’s Vehicles thereby minimizing extra costs 
						</li>
						<li class="margintop10">The Directorate’s staffs were provided with different trainings regarding stock management, inventory control, and vehicle maintenance and handling
						</li>
						<li class="margintop10">Property stores were arranged based on the Kaizen philosophy
						</li>
					</ul>
