...
<head>
  <meta charset="utf-8">
  <title>College of Medicine and Health Science</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">College of Medicine and Health Science</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>College of Medicine and Health Science</strong></h4>
					<p>
