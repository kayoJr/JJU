          ...
          <div class="span4">
            <aside class="left-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="cat">
                  <li><i class="icon-angle-right"></i><a href="#">Meetings</a></li>
                  <li><i class="icon-angle-right"></i><a href="#">Conferances</a></li>
                  <li><i class="icon-angle-right"></i><a href="#">Annual </a></li>
                  <li><i class="icon-angle-right"></i><a href="#">Notes</a><span> (12)</span></li>
                  <li><i class="icon-angle-right"></i><a href="#">Quotes</a><span> (18)</span></li>
                </ul>
              </div>
              <div class="widget">
            ...
            <article>
              <div class="row">
                <div class="span8">
                  ...
                  <p><h6><a href="#">This is an example of standard post format</a></h6>
