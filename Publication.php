        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><a href="">Offices</a><i class="icon-angle-right"></i></li>
				...
				<div class="span12">
					...
					<div class="span6">
						<div class="flexslider">
						  <ul class="slides">
							<li>
							  <img src="img/works/full/pub1.jpg" alt="" />
							</li>
							<li>
							  <img src="img/works/full/pub2.jpg" alt="" />
							</li>
							<li>
							  <img src="img/works/full/pub3.jpg" alt="" />
							</li>
						  </ul>
						</div>
					</div>
					<div class="span6">
						<h4 class="heading"><strong>Publication</strong></h4>
