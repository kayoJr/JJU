...
<head>
  <meta charset="utf-8">
  <title>Somali Language Institute</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Institute of Somali Language and Literature Studies</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>Institute of Somali Language and Literature Studies</strong></h4>
					<h4 class="heading"><strong>Mac’hadka Daraasaadka Af-soomaaliga iyo Suugaanta</strong></h4>
					<p>
					...
					<div class="span5 offset2">
						<div class="flexslider">
						  <ul class="slides">
							<li>
							  <img src="img/works/full/som1.jpg" alt="" />
							</li>
							<li>
							  <img src="img/works/full/som2.jpg" alt="" />
							</li>
