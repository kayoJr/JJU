        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><a href="">Directorate of Research Publication and Technology Transfer</a><i class="icon-angle-right"></i></li>
              <li class="active">ThematicArea</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>Research thematic areas of Jigjiga University</strong></h4>
					
				
					<ul>
						  <li>Livelihood </li>
						  <li>Food security and poverty alleviation </li>
						  <li>Human health and well-being </li>
						  <li>Society governance and human development 
						  </li>
						  <li>Engineering and technology</li>
						  <li>Business and economic development </li>
						  <li>Basic science research and crosscutting research issues</li>
					</ul>
