        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">College of Business and Economics</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">	
					...
					<div class="span5">
						<div class="flexslider">
						  <ul class="slides">
							<li>
							  <img src="img/works/full/cobe1.jpg" alt="" />
							</li>
							<li>
							  <img src="img/works/full/cobe2.jpg" alt="" />
							</li>
						  </ul>
						</div>
					</div>
					<div class="span6">
					<h5 class="heading"><strong>College of Business and Economics</strong></h5>
					<p>
                    The College of Business and Economics <strong>(CoBE)</strong> was established in 2007, right after the University was founded.
