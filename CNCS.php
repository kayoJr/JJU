...
<head>
  <meta charset="utf-8">
  <title>College of Natural and Computational Science</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">College of Natural and Computational Science</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>College of Natural and Computational Science</strong></h4>
					<p>
                    Based on its three mandates (teaching learning process, research and community services) and to maintain quality of education, the College of Natural and Computational Science <strong>(CNCS)</strong> seriously works in human power development and fulfillment of resources particularly for practical education. 
					</p>
					<p>
					...
					<div class="row">
					<div class="aligncenter"><img src="img/cncs/pic1.png" title="CNCS Staffs organize monthly seminar presentation on different issues where graduating students also attend" /></div>
					</div>
