...
<head>
  <meta charset="utf-8">
  <title>College of Dryland Agriculture</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">College of Dryland Agriculture</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>College of Dryland Agriculture</strong></h4>
					<div class="row">
					<div class="span5">
						<div class="flexslider">
							  <ul class="slides">
								<li>
								  <img src="img/works/full/cda1.jpg" alt="" />
								</li>
								<li>
								  <img src="img/works/full/cda2.jpg" alt="" />
								</li>
							  </ul>
						</div>
					</div>
