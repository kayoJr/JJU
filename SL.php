        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">School of Law</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<h4 class="heading"><strong>School of Law</strong></h4>
					<p>
					...
					<h6>Major achievements of the School this year</h6>
					<p>
					...
					<div class="row">
					<div class="aligncenter"><img src="img/schools/law/pic1.jpg" title="JJU’s Liban Zone Legal Aid Center" /></div>
					</div>
