		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				<div class="span12">
					...
					<h4 class="heading"><strong>Directorate of Research Publication and Technology Transfer</strong></h4>
					<div class="span6">
						<!-- start flexslider -->
						...
						<div class="flexslider">
						  <ul class="slides">
							<li>
							  <img src="img/works/full/drptt1.jpg" alt="" />
							</li>
							<li>
							  <img src="img/works/full/drptt2.jpg" alt="" />
							</li>
