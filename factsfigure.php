...
<head>
  <meta charset="utf-8">
  <title>JJU Facts and Figures</title>
        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">Facts and Figures</li>
            </ul>
          </div>
        </div>
      </div>
		...
		<div class="container">
			<div class="row" style="margin-top:-40px;">
				...
				<div class="testimonial">
					...
					<ul>
						<li>JJU was established in March, 2007
						</li>
						<li class="margintop10"> Area size (in hectares): 350 hectares (main campus, excluding the Meles Zenawi Memorial Referral Hospital campus) 
						</li>
						<li class="margintop10">Built-up area (sq.mts): 2/3 of the entire campus land 
						</li>
						<li class="margintop10">Internet connection: The campus is entirely Wi-Fi enabled 
						</li>
						<li class="margintop10">No. of colleges: 8
						</li>
						<li class="margintop10">No. of institutes: 1
						</li>
						<li class="margintop10">No. of schools:  3
						</li>
						<li class="margintop10">No. of academic departments: 54 (40 undergraduate regular programs, 3 undergraduate summer programs, 2 undergraduate upgrading programs, and 9 post-graduate regular programs) 
						</li>
						<li class="margintop10">Students’ enrolment as of 2016/17 A/Y:  21, 379
						</li>
						<li class="margintop10">Total staff residence units: 168
						</li>
						<li class="margintop10">Total academic staffs on duty: 722
						</li>
						<li class="margintop10">Total academic staffs on study leave: 274
						</li>
						<li class="margintop10">Total administration staffs (non-teaching staff): 758
						</li>
					</ul>
