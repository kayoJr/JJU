                  ...
                  <ul class="nav topnav">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="index-alt2.php">Homepage 2</a></li>
                        <li><a href="index-alt3.php">Homepage 3</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="animations.php">56 Animations</a></li>
                        <li><a href="icons.php">Icons</a></li>
                        <li><a href="icon-variations.php">Icon variations</a></li>
                        <li class="dropdown"><a href="#">3 Sliders <i class="icon-angle-right"></i></a>
                          <ul class="dropdown-menu sub-menu-level1">
                            <li><a href="index.php">Nivo slider</a></li>
                            <li><a href="index-alt2.php">Slit slider</a></li>
                            <li><a href="index-alt3.php">Parallax slider</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    <li class="dropdown active">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="pricingbox.php">Pricing boxes</a></li>
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="portfolio-2cols.php">Portfolio 2 columns</a></li>
                        <li><a href="portfolio-3cols.php">Portfolio 3 columns</a></li>
                        <li><a href="portfolio-4cols.php">Portfolio 4 columns</a></li>
